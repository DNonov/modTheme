...
theme.set_highlights = function(opts)
    local c = require('modTheme.colors').get_colors()
    ...
    hl(0, 'String', { fg = c.vscLightGreen, bg = 'NONE' })
    ...
    hl(0, 'Function', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, '@function.builtin', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@function', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@function.macro', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@parameter', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@parameter.reference', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@method', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@field', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@property', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@constructor', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@conditional', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@repeat', { fg = c.vscBlue, bg = 'NONE' })
    ...
    hl(0, '@storageClass', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@structure', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@include', { fg = c.vscBlue, bg = 'NONE' })
    ...
    hl(0, 'phpMethod', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'phpClass', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'phpFunction', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'jsFuncCall', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'typescriptGlobalMethod', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'typescriptPromiseMethod', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'sqlFunction', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'sqlOperator', { fg = c.vscFront, bg = 'NONE' })
