...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Character', { fg = c.vscGreen, bg = 'NONE' })
    hl(0, 'Number', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'cssValueNumber', { fg = c.vscGreen, bg = 'NONE' })
    ...
    hl(0, 'jsSpreadOperator', { fg = c.vscBlue, bg = 'NONE' })
    ...
    hl(0, 'GitGutterChange', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'GitGutterDelete', { fg = c.vscRed, bg = 'NONE' })

    -- Git Signs
    hl(0, 'GitSignsAdd', { fg = c.vscGreen, bg = 'NONE' })
    hl(0, 'GitSignsChange', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'NvimTreeBookmark', { fg = c.vscGreen, bg = 'NONE' })
    hl(0, 'NvimTreeExecFile', { fg = c.vscRed, bg = 'NONE' })
    hl(0, 'NvimTreeOpenedFile', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'NvimTreeModifiedFile', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'CmpItemKindInterface', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'CmpItemKindConstructor', { fg = c.vscOrange, bg = 'NONE' })
